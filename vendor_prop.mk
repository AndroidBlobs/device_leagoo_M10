PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    bgw.current3gband=0 \
    bird_em_verno=LEAGOO_M10_OS3.0_E_2019.1.1 \
    ...
    persist.log.tag.AntiTheftManager=E \
    persist.log.tag.AudioALSADeviceConfigManager=E \
    persist.log.tag.AudioALSADriverUtility=E \
    persist.log.tag.AudioALSAHardwareResourceManager=E \
    persist.log.tag.AudioALSAPlaybackHandlerBase=E \
    persist.log.tag.AudioALSAVolumeController=E \
    persist.log.tag.AudioFlinger_Threads=E \
    persist.log.tag.AudioMTKFilter=E \
    persist.log.tag.AudioTrack=E \
    persist.log.tag.AutoRegSmsFwk=I \
    persist.log.tag.BufferQueue=E \
    persist.log.tag.BufferQueueConsumer=E \
    persist.log.tag.BufferQueueProducer=E \
    persist.log.tag.C2K_RIL-DATA=I \
    persist.log.tag.CapaSwitch=I \
    persist.log.tag.CarrierText=E \
    ...
    persist.log.tag.DataShapingService=E \
    ...
    persist.log.tag.EmergencyButton=E \
    persist.log.tag.EventHub=E \
    ...
    persist.log.tag.GoogleInputMethod=E \
    ...
    persist.log.tag.HWUIExtension=E \
    ...
    persist.log.tag.Input=E \
    persist.log.tag.IsimFileHandler=I \
    persist.log.tag.IsimRecords=I \
    persist.log.tag.KeyguardSecurityModel=E \
    persist.log.tag.KeyguardSecurityView=E \
    persist.log.tag.KeyguardUpdateMonitor=E \
    persist.log.tag.MAL-Daemon=E \
    persist.log.tag.MAL-RDS=E \
    ...
    persist.log.tag.MtkAudioBitConverter=E \
    persist.log.tag.MtkAudioLoud=E \
    ...
    persist.log.tag.MtkPhoneIntfMgrEx=E \
    ...
    persist.log.tag.NativeCrypto=E \
    ...
    persist.log.tag.NetworkStatsRecorder=E \
    persist.log.tag.OperatorUtils=I \
    persist.log.tag.PQ=E \
    ...
    persist.log.tag.RecurrenceRule=E \
    ...
    persist.log.tag.StatusBar=E \
    persist.log.tag.StatusBarKeyguardViewManager=E \
    persist.log.tag.SuppMsgMgr=I \
    persist.log.tag.SuppSrvConfig=I \
    persist.log.tag.Surface=E \
    ...
    persist.log.tag.WifiController=E \
    persist.log.tag.WifiService=E \
    persist.log.tag.WindowManager=E \
    persist.log.tag.jiangj=E \
    persist.log.tag.lights=E \
    persist.log.tag.palm=E \
    persist.log.tag.powerd=E \
    ...
    ro.bdfun.add_screensaver=true \
    ro.bdfun.backup_sensor=true \
    ro.bdfun.camera_light_max=true \
    ro.bdfun.camera_zsd_on=true \
    ro.bdfun.compat_mark_check=true \
    ro.bdfun.double_ringtone=true \
    ro.bdfun.fakefocus=0 \
    ro.bdfun.ft_hs_ctrl=true \
    ro.bdfun.hardware_info=true \
    ro.bdfun.inner_sw_version=7130TQF_L5503L.A1.20190219.AD80.V10.HD-.DS883.B18.TST.EN \
    ro.bdfun.mccmnc_lock_common=true \
    ro.bdfun.mccmnc_lock_default=true \
    ro.bdfun.mmi_backup_camera=-1 \
    ro.bdfun.mmi_tflash_fake=true \
    ro.bdfun.mosilent=true \
    ro.bdfun.mt_bat_id=true \
    ro.bdfun.mt_bt=true \
    ro.bdfun.mt_dial112=true \
    ro.bdfun.mt_enable=true \
    ro.bdfun.mt_flashlight=true \
    ro.bdfun.mt_fm=true \
    ro.bdfun.mt_g_sensor=true \
    ro.bdfun.mt_gps=true \
    ro.bdfun.mt_gps_man_check=true \
    ro.bdfun.mt_headset=true \
    ro.bdfun.mt_l_sensor=true \
    ro.bdfun.mt_lcd_tap=true \
    ro.bdfun.mt_led=true \
    ro.bdfun.mt_m_kb_led=true \
    ro.bdfun.mt_main_camera=true \
    ro.bdfun.mt_ps=true \
    ro.bdfun.mt_sensor=true \
    ro.bdfun.mt_sub_camera=true \
    ro.bdfun.mt_touch=true \
    ro.bdfun.mt_tpdraw_fwvga=true \
    ro.bdfun.mt_wifi=true \
    ro.bdfun.mt_z_sensor=true \
    ro.bdfun.new_notification_style=true \
    ro.bdfun.security_patch_menu=true \
    ro.bdfun.show_ampm=true \
    ro.bdfun.skip_setupwizard=true \
    ro.bdfun.speeddial=true \
    ro.bdfun.sub_flash_support=true \
    ro.bdfun.yiyu_smart=true \
    ro.bdmisc.build_number=LEAGOO_M10_OS3.0_E_2019.1.1 \
    ro.bdmisc.launcher_unread=true \
    ro.bdmisc.mtk_patch_version=alps-o1.mp1-V1.132.2 \
    ro.bdmisc.mtp_label=LEAGOO__M10 \
    ro.bdmisc.mtp_manufacturer=LEAGOO \
    ro.bdmisc.mtp_model=LEAGOO__M10 \
    ro.bdmisc.shutter_sound=on \
    ro.bdmisc.software_version=LEAGOO_M10_OS3.0_E_2019.1.1 \
    ro.bdmisc.wlan_direct_name=LEAGOO__M10 \
    ro.bdmisc.wlan_ssid_name=LEAGOO__M10 \
    ro.bdui.battery_option_dup_hide=true \
    ro.bdui.statusbar_ampm_style=2 \
    ro.bird.custom.sw.version=LEAGOO_M10_OS3.0_E_2019.1.1 \
    ro.carrier=unknown \
    ...
    ro.config.ringtone_sim2=LEAGOO-Turkish.mp3 \
    ...
    ro.mtk.dex2oat_white_list=com.facebook.katana \
